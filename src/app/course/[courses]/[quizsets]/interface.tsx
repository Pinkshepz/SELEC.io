            ...
            <div className="flex flex-col overflow-hidden pt-16">
                {
                    ...
                    <>
                        <div className='-full-screen flex flex-col relative px-4 pb-24 lg:pb-0 bg-white/90 dark:bg-zinc-900/70 backdrop-blur-md'>
                            ...
                            {/* Question */}
                            <div className='-question-panel pt-2 lg:pb-4 flex flex-col lg:flex-row justify-center items-center'>
                                {/* Question Image */}
                                ...
                                <div className='flex flex-col h-full w-full justify-between'>
                                    {/* 3 Icons */}
                                    <div className='flex flex-wrap justify-center lg:mb-4 lg:mt-0 gap-2'>
                            ...
                            <div className='-choice-panel'>
                                { !activeSelectedQuestions[currentQuiz].graded ?
                                    <div className='flex flex-col lg:flex-row gap-4 h-full'>
                                        ...
                                        <div className={'h-full w-full rounded-xl bg-white/50 dark:bg-zinc-900/70'}>
                                    ...
                                    (choicesStatus[currentQuiz].choice1 ? "border text-indigo-600 dark:text-indigo-500 border-indigo-600 dark:border-indigo-500 bg-indigo-600/10 dark:bg-indigo-500/10" 
                                        ...
                                        <div className={'h-full w-full rounded-xl bg-white/50 dark:bg-zinc-900/70'}>
                                            <button onClick={() => handleChoiceInteract("choice2", activeSelectedQuestions[currentQuiz].Mode)}
                                                className={'px-2 py-3 w-full h-full font-bold text-lg sm:text-xl rounded-xl ' + 
                                    (choicesStatus[currentQuiz].choice2 ? "border text-indigo-600 dark:text-indigo-500 border-indigo-600 dark:border-indigo-500 bg-indigo-600/10 dark:bg-indigo-500/10" 
                                                    : "border border-gray-300 dark:border-neutral-700")}>
                                        ...
                                        <div className={'h-full w-full rounded-xl bg-white/50 dark:bg-zinc-900/70'}>
                                            <button onClick={() => handleChoiceInteract("choice3", activeSelectedQuestions[currentQuiz].Mode)}
                                                className={'px-2 py-3 w-full h-full font-bold text-lg sm:text-xl rounded-xl ' + 
                                    (choicesStatus[currentQuiz].choice3 ? "border text-indigo-600 dark:text-indigo-500 border-indigo-600 dark:border-indigo-500 bg-indigo-600/10 dark:bg-indigo-500/10" 
                                                    : "border border-gray-300 dark:border-neutral-700")}>
                                        ...
                                        <div className={'h-full w-full rounded-xl bg-white/50 dark:bg-zinc-900/70'}>
                                            <button onClick={() => handleChoiceInteract("choice4", activeSelectedQuestions[currentQuiz].Mode)}
                                                className={'px-2 py-3 w-full h-full font-bold text-lg sm:text-xl rounded-xl ' + 
                                    (choicesStatus[currentQuiz].choice4 ? "border text-indigo-600 dark:text-indigo-500 border-indigo-600 dark:border-indigo-500 bg-indigo-600/10 dark:bg-indigo-500/10" 
                                                    : "border border-gray-300 dark:border-neutral-700")}>
                                        ...
                                        <div className={'h-full w-full rounded-xl bg-white/50 dark:bg-zinc-900/70'}>
                                            <button onClick={() => handleChoiceInteract("choice5", activeSelectedQuestions[currentQuiz].Mode)}
                                                className={'px-2 py-3 w-full h-full font-bold text-lg sm:text-xl rounded-xl ' + 
                                    (choicesStatus[currentQuiz].choice5 ? "border text-indigo-600 dark:text-indigo-500 border-indigo-600 dark:border-indigo-500 bg-indigo-600/10 dark:bg-indigo-500/10" 
                                                    : "border border-gray-300 dark:border-neutral-700")}>
