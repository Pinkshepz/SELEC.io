        ...
        <div className='flex flex-col'>
            <div id='quiz-two-cols-fixed' key='interface'>
                ...
                <main id="quiz-col-scroll-main" className='-scroll-none backdrop-blur-xl' key='interface-main'>
                    ...
                    {/* 03 - Choice */}
                    <div className={'-scroll-none relative h-full lg:h-full w-full flex flex-col lg:grid gap-4 ' + (Object.keys(questionArray[interfaceParams.currentQuestion].choices).length == 1 ? 'lg:grid-cols-1' : 'lg:grid-cols-2')}>
                        {ChoiceObject}
                    </div>
