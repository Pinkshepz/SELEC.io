...
export default function QuizInterface ({
    ...
    Object.keys(headerData.TopicCount).map((topic) => {
     ...
     const [quizStatus, setQuizStatus] = useState<{
            ...
            shuffleQuiz: ((headerData.QuestionShuffle == "FALSE") ? false : true),
            shuffleChoice: ((headerData.ChoiceShuffle == "FALSE") ? false : true),
        ...
        <div className="relative">
            {
                ...
                // ==================================
                pageStatus == "START" ?
                <div className='min-h-[100lvh] relative px-4 pt-20 md:pt-8 pb-4 md:pb-0 md:flex md:items-center md:justify-center backdrop-blur-md'>
        
                    {/* Start page content */}
                    <div id='card-main' className="relative md:w-[75dvw] md:p-6 md:m-16">
                        <div className='flex flex-row items-center'>
                            ...
                            <h6 className="flex flex-row gap-1 ml-2">{headerData.Ref}</h6>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row mt-6 mb-8">
                            ...
                            <div className="flex flex-wrap gap-8">
                                ...
                                <div className="flex">
                                    ...
                                    <div className="ml-2">
                                        <p className="ml-1 after:bg-slate-700 dark:after:bg-slate-200">
                                            Quiz Mode</p>
